Arena = function(game) //on créée notre objet Arena qui prend l'objet game en argument
{
    ...
    */
var lightPoint = new BABYLON.PointLight("pointLight", new BABYLON.Vector3(1, 10 +deltat, 1), scene);
var lightDir = new BABYLON.DirectionalLight("DirectionalLight", new BABYLON.Vector3(0, -1, 0), scene);
var lightSpot = new BABYLON.SpotLight("spotLight", new BABYLON.Vector3(0, 30+deltat, -10), new BABYLON.Vector3(0, -1, 0), Math.PI / 3, 2, scene);
...
*/
    ...
    */
    ...
    var mainBox = BABYLON.Mesh.CreateBox("box2", 10, scene);
       ...
       mainBox.position = new BABYLON.Vector3(5,20,5);
